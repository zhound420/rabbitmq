...
class RabbitMQTool(BaseTool, BaseModel):
    ...
    def connection_params(self):
        return pika.ConnectionParameters(host=self.rabbitmq_server, credentials=pika.PlainCredentials(self.rabbitmq_username, self.rabbitmq_password))
        ...
        if isinstance(tool_input, str):
            try:
                ...
                tool_input = {
                    ...
                    "receiver": "Linda",  # Placeholder; should be determined dynamically
                    "content": tool_input
                }
